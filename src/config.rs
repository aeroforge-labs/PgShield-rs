...
#[command(name = "pgshield", author = "eddiere", version = "0.1.0", about = "PostgreSQL Wire Protocol Proxy & Query Firewall")]
pub struct Config {
    /// Socket address for PgShield to listen on (e.g., 0.0.0.0:6432)
    #[arg(short = 'l', long, env = "PGSHIELD_LISTEN_ADDR", default_value = "0.0.0.0:6432")]
    pub listen_addr: SocketAddr,

    /// Backend PostgreSQL server host
    #[arg(short = 'H', long, env = "POSTGRES_BACKEND_HOST", default_value = "127.0.0.1")]
    pub backend_host: String,

    /// Backend PostgreSQL server port
    #[arg(short = 'P', long, env = "POSTGRES_BACKEND_PORT", default_value = "5432")]
    ...
    #[arg(short = 'f', long, env = "FIREWALL_STRICT_MODE", default_value_t = true)]
